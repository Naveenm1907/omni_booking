...
void main() {
  testWidgets('service selection updates basket totals', (tester) async {
    ...
    controller.add(const <Service>[
      Service(id: 's1', name: 'Cut', durationMinutes: 30, priceCents: 1500),
      Service(id: 's2', name: 'Shave', durationMinutes: 15, priceCents: 800),
    ]);
    await tester.pump();

    expect(find.text('Pick time'), findsOneWidget);
    expect(find.textContaining('Duration and price update live'), findsOneWidget);
